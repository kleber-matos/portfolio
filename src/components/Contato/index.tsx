  ...
  return (
    <section className="flex justify-center items-center lg:h-screen">
      <section className="w-1/2  flex flex-col justify-center items-center">
        ...
        <ul className="lg:w-10/12">
          <li>
            <a
              className="border flex items-center justify-between p-10 m-3 lg:w-2/2 bg-[#343A40] text-white dark:bg-white dark:text-black h-20 rounded-sm text-center "
